...
final class Version20211201092853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE image image VARCHAR(255) NOT NULL, CHANGE wine_house wine_house VARCHAR(255) NOT NULL, CHANGE grapes grapes VARCHAR(255) NOT NULL, CHANGE wine_sort wine_sort VARCHAR(255) NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE region region VARCHAR(255) NOT NULL');
    }
